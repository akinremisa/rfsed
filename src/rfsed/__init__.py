...
These methods include: Iterative trial and error fitting of observed receiver functions with synthetic ones,  wavefield continuation and decomposition technique, application of band-pass or resonance filters to remove the sediment signals in the receiver functions, 
sequential H-k stacking, and combination of H-k stacking and waveform fitting. 
